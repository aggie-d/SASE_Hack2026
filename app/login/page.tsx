...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-900 flex flex-col justify-between items-center relative p-4 overflow-hidden">
      {/* Decorative Background Elements matching signup */}
        ...
        >
          ...
          <form className="relative z-10 space-y-4">
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full rounded-xl bg-gradient-to-b from-[#DFB338] to-[#B8911E] py-3.5 text-sm font-bold text-stone-900 shadow-[0_0_20px_rgba(201,162,39,0.3)] hover:shadow-[0_0_25px_rgba(201,162,39,0.5)] transition-all active:scale-[0.99]"
              >
                Log In
              </button>
            </div>
